...
export const mockStoryList: StoryCardListSchema = Array.from({ length: 5 }).map(() => ({
  id: 1,
...
export const mockStoryList2: StoryCardListSchema = Array.from({ length: 3 }).map(() => ({
  id: 1,
  summary:
...
export const mockStoryList3: StoryCardListSchema = Array.from({ length: 1 }).map(() => ({
  id: 1,
  summary:
...
export const mockAllStoryList: StoryCardListSchema = [
  ...mockStoryList,
  ...mockStoryList2,
  ...mockStoryList3,
];
